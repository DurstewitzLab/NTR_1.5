...
cum_pair_stats=50.*ones(val_blocks,n_combi,8);
%
...
for i=1:val_blocks,
    ...
    for j=1:n_combi,
        ...
        if ~isempty(basic_stats)
            ...
            %
            %Correction to pairwise manova stats.
...
% 
means_js=zeros(15,1);means_lambda=zeros(15,1);means_mhd=zeros(15,1);means_lambda2=zeros(15,1);
es_js=zeros(15,1);es_lambda=zeros(15,1);es_mhd=zeros(15,1);es_lambda2=zeros(15,1);
%
for com=1:n_combi,
      js_c=js(:,com);
