function display_flow(data,labels,trial_range,order,index_plot)
...
%       and other values compress or expand all vectors afther such
%       automatical scaling.
%
...
while count<n,
    if labels(count)==1
       ...
       if flags(1),
           ...
           text(up_lim(1),low_lim(2)/2,up_lim(3),'Epoch 1','Color','b','FontName','Arial','FontSize',8);
    ...
    elseif labels(count)==2,
        ...
        hold on
        if flags(2),
           text(up_lim(1),low_lim(2)/2,up_lim(3)-step,'Epoch 2','Color','r','FontName','Arial','FontSize',8);
    ...
    elseif (labels(count)==3)&&(n_labels>2),
        ...
        hold on
        if flags(3),
           text(up_lim(1),low_lim(2)/2,up_lim(3)-2*step,'Epoch 3','Color','g','FontName','Arial','FontSize',8);
    ...
    elseif (labels(count)==4)&&(n_labels>3),
        ...
        hold on
        if flags(4),
           text(up_lim(1),low_lim(2)/2,up_lim(3)-3*step,'Epoch 4','Color','k','FontName','Arial','FontSize',8);
    ...
    elseif (labels(count)==5)&&(n_labels>4),
        ...
        hold on
        if flags(5),
           text(up_lim(1),low_lim(2)/2,up_lim(3)-4*step,'Epoch 5','Color','y','FontName','Arial','FontSize',8);
    ...
    elseif (labels(count)==6)&&(n_labels>5),
        ...
        hold on
        if flags(6),
           text(up_lim(1),low_lim(2)/2,up_lim(3)-5*step,'Epoch 6','Color','c','FontName','Arial','FontSize',8);
    ...
    elseif (labels(count)==8)&&(n_labels>7),
        ...
        hold on
        if flags(8),
            text(up_lim(1),low_lim(2)/2,up_lim(3)-7*step,'Epoch 6','Color',[0.4,0.4,0.4],'FontName','Arial','FontSize',8);
